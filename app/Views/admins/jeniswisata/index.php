...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Jenis Wisata</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Data Jenis Wisata</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="card-header">
                ...
                <div class="modal fade" id="modal-primary">
                    ...
                    <div class="modal-content">
                        ...
                        <h4 class="modal-title">Tambah Jenis Wisata</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        </div>
                        <form action="/jeniswisata/savedatawisata" method="post">
                  ...
                  <tbody>
                    <?php foreach($jeniswisata as $row):?>
                        <tr>
                            ...
                            <td><?=$row['nama'];?></td>
                            <td>
                                <a href="/jeniswisata/editjeniswisata/<?=$row['id'];?>" class="btn btn-info">Edit</a>
                                <a href="/jeniswisata/hapusjeniswisata/<?=$row['id'];?>" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach;?>
                  <tfoot>
